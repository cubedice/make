# Django settings for make project.
...
DATABASE_NAME = 'sqlite3.sql'             # Or path to database file if using sqlite3.
...
SECRET_KEY = '^yltijwd)v6=0q3s&8swr!t6dem!kf#hk0orq5$nyn40iz2w@8'
